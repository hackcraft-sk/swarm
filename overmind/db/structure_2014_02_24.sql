...
--
-- Host: localhost:3306
-- Generation Time: Feb 24, 2014 at 04:33 AM
...
CREATE TABLE IF NOT EXISTS `bots` (
  ...
  KEY `user` (`userId`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1381 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=169647 ;
